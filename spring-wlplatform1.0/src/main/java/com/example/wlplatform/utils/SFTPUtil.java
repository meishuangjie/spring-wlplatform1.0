...
public class SFTPUtil {
    ...
    public static void main(String[] args) {
        ...
        client.setServer("118.89.249.100");
        client.setPort(22);
        client.setLogin("root");
        client.setPassword("msj3760575!");

        client.connect();

        try {
//            client.uploadFile("/root/uploaded.txt", "/uploaded.txt");

            client.retrieveFile("/root/haproxy-1.7.2.tar.gz", "D:\\aaa");
